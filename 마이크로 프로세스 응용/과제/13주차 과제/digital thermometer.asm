...
forever:
	...
	cpi segen, 2;
	breq Dot;						두 번째 숫자판 점등시 점을 찍는다
	out PORTC, leddata;				leddata에 저장되어있는 led data를 출력
	rjmp forever;

	Dot:
	ori leddata, $80;				or 연산을 통해 leddata 레지스터에 점에 해당하는 led 값을 더해준다
	out PORTC, leddata;
	rjmp forever;		
...
ModifyFND:
	...
	mov temp, TWIdataH;		상위 바이트를 temp에 저장
	...
	mov temp, TWIdataL;		하위 바이트를 temp에 저장
	andi temp, $80;
	cpi temp, 0;
...
SegData:
	.db $3f, $06, $5b, $4f, $66, $6d, $7d, $07, $7f, $6f, $77, $7c, $39, $5e, $79, $71 ,$40, $00			// 0~F에 해당하는 led data 와 "-" , " "
